makeBigPlotAssumptions <- function(label){
  ...
  #   ---- Row 1
  plotText("Objective 1 Checking Assumptions and Residuals Analysis.",5)
  ...
  plotEmpty()
  if( exists("fitDu") ){
    plotAllObj1(dat,fitDu,"D",2010,brewer.pal(9,"Paired")[5:6],0.10,2008)    # red
    plotEmpty()
    plotAllObj1(dat,fitDl,"D",2010,brewer.pal(9,"Paired")[5:6],0.10,2008)    # red
    plotEmpty()
    plotAllObj1(dat,fitDa,"D",2010,brewer.pal(9,"Paired")[5:6],0.10,2008)    # red
    plotEmpty()
    plotAllObj1(dat,fitUu,"U",2010,brewer.pal(9,"Paired")[9:10],0.10,2008)   # purple
    plotEmpty()
    plotAllObj1(dat,fitUl,"U",2010,brewer.pal(9,"Paired")[9:10],0.10,2008)   # purple
    plotEmpty()
    plotAllObj1(dat,fitUa,"U",2010,brewer.pal(9,"Paired")[9:10],0.10,2008)   # purple
  } else {
    replicate(13,{plotEmpty()})  # why 13?  should be 11?
  }
  plotEmpty()
  ...
  plotEmpty()
  plotHistObj1(dat,"S",95,"pCoveru")
  plotEmpty()
  plotHistObj1(dat,"S",95,"pCoverl")
  plotEmpty()
  plotHistObj1(dat,"S",95,"pCovera")
  plotEmpty()
  ...
  plotEmpty()
  plotHistObj1(dat,"D",95,"pCoveru")
  plotEmpty()
  plotHistObj1(dat,"D",95,"pCoverl")
  plotEmpty()
  plotHistObj1(dat,"D",95,"pCovera")
  plotEmpty()
