makeBigPlotAssumptionsObj1 <- function(tc){
  

    
  png(paste0("//lar-file-srv/Data/NPS/Prairie/Analysis/Trending/Objective1-Assumptions.png"),width=36,height=90,units="in",res=300)
  ...
  plotEmpty()
  plotAllObj1(dat,fitDu,"VegType","D",tc,brewer.pal(9,"Paired")[5:6],0.10,2008)    # orange
  plotEmpty()
  plotAllObj1(dat,fitDl,"VegType","D",tc,brewer.pal(9,"Paired")[5:6],0.10,2008)    # orange
  plotEmpty()
  plotAllObj1(dat,fitDa,"VegType","D",tc,brewer.pal(9,"Paired")[5:6],0.10,2008)    # orange
  plotEmpty()
  plotAllObj1(dat,fitUu,"VegType","U",tc,brewer.pal(9,"Paired")[9:10],0.10,2008)    # green
  plotEmpty()
  plotAllObj1(dat,fitUl,"VegType","U",tc,brewer.pal(9,"Paired")[9:10],0.10,2008)    # green
  plotEmpty()
  plotAllObj1(dat,fitUa,"VegType","U",tc,brewer.pal(9,"Paired")[9:10],0.10,2008)    # green
  plotEmpty()
  ...
  plotEmpty()
  plotRanEfQQ("LocCode",fitDu,brewer.pal(9,"Paired")[5],column=1)
  plotEmpty()
  plotRanEfQQ("LocCode",fitDl,brewer.pal(9,"Paired")[5],column=1)
  plotEmpty()
  plotRanEfQQ("LocCode",fitDa,brewer.pal(9,"Paired")[5],column=1)
  plotEmpty()
  plotRanEfQQ("LocCode",fitUu,brewer.pal(9,"Paired")[9],column=1)
  plotEmpty()
  plotRanEfQQ("LocCode",fitUl,brewer.pal(9,"Paired")[9],column=1)
  plotEmpty()
  plotRanEfQQ("LocCode",fitUa,brewer.pal(9,"Paired")[9],column=1)
  plotEmpty()
  ...
  plotEmpty()
  plotRanEfQQ("LocCode",fitDu,brewer.pal(9,"Paired")[5],column=2)
  plotEmpty()
  plotRanEfQQ("LocCode",fitDl,brewer.pal(9,"Paired")[5],column=2)
  plotEmpty()
  plotRanEfQQ("LocCode",fitDa,brewer.pal(9,"Paired")[5],column=2)
  plotEmpty()
  plotRanEfQQ("LocCode",fitUu,brewer.pal(9,"Paired")[9],column=2)
  plotEmpty()
  plotRanEfQQ("LocCode",fitUl,brewer.pal(9,"Paired")[9],column=2)
  plotEmpty()
  plotRanEfQQ("LocCode",fitUa,brewer.pal(9,"Paired")[9],column=2)
  plotEmpty()
  ...
  plotEmpty()
  plotSpatialResids(fitDu,STransects,2012,tc,"Reds")
  plotEmpty()
  plotSpatialResids(fitDl,STransects,2012,tc,"Reds")
  plotEmpty()
  plotSpatialResids(fitDa,STransects,2012,tc,"Reds")
  plotEmpty()
  plotSpatialResids(fitUu,STransects,2012,tc,"Purples")
  plotEmpty()
  plotSpatialResids(fitUl,STransects,2012,tc,"Purples")
  plotEmpty()
  plotSpatialResids(fitUa,STransects,2012,tc,"Purples")
  plotEmpty()
