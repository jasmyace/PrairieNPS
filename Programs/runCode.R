...
write.csv(dat,"//lar-file-srv/Data/NPS/Prairie/Analysis/Trending/datObjective1.csv")

#   ---- Fit all 15 full models.  
fitHu <- lmer(pCoveru ~ 1 + WYear + (1 + WYear | LocCode) + (1|Year),data=dat[dat$VegType == "H",])
fitSu <- lmer(pCoveru ~ 1 + WYear + (1 + WYear | LocCode) + (1|Year),data=dat[dat$VegType == "S",])
fitTu <- lmer(pCoveru ~ 1 + WYear + (1 + WYear | LocCode) + (1|Year),data=dat[dat$VegType == "T",])
fitDu <- lmer(pCoveru ~ 1 + WYear + (1 + WYear | LocCode) + (1|Year),data=dat[dat$VegType == "D",])
fitUu <- lmer(pCoveru ~ 1 + WYear + (1 + WYear | LocCode) + (1|Year),data=dat[dat$VegType == "U",])

fitHl <- lmer(pCoverl ~ 1 + WYear + (1 + WYear | LocCode) + (1|Year),data=dat[dat$VegType == "H" & dat$pCoverl < Inf,])
fitSl <- lmer(pCoverl ~ 1 + WYear + (1 + WYear | LocCode) + (1|Year),data=dat[dat$VegType == "S" & dat$pCoverl < Inf,])
fitTl <- lmer(pCoverl ~ 1 + WYear + (1 + WYear | LocCode) + (1|Year),data=dat[dat$VegType == "T" & dat$pCoverl < Inf,])
fitDl <- lmer(pCoverl ~ 1 + WYear + (1 + WYear | LocCode) + (1|Year),data=dat[dat$VegType == "D" & dat$pCoverl < Inf,])
fitUl <- lmer(pCoverl ~ 1 + WYear + (1 + WYear | LocCode) + (1|Year),data=dat[dat$VegType == "U" & dat$pCoverl < Inf,])

fitHa <- lmer(pCovera ~ 1 + WYear + (1 + WYear | LocCode) + (1|Year),data=dat[dat$VegType == "H",])
fitSa <- lmer(pCovera ~ 1 + WYear + (1 + WYear | LocCode) + (1|Year),data=dat[dat$VegType == "S",])
fitTa <- lmer(pCovera ~ 1 + WYear + (1 + WYear | LocCode) + (1|Year),data=dat[dat$VegType == "T",])
fitDa <- lmer(pCovera ~ 1 + WYear + (1 + WYear | LocCode) + (1|Year),data=dat[dat$VegType == "D",])
fitUa <- lmer(pCovera ~ 1 + WYear + (1 + WYear | LocCode) + (1|Year),data=dat[dat$VegType == "U",])
...
write.csv(dat,"//lar-file-srv/Data/NPS/Prairie/Analysis/Trending/datObjective2.csv")
...
write.csv(dat,"//lar-file-srv/Data/NPS/Prairie/Analysis/Trending/datObjective3.csv")
